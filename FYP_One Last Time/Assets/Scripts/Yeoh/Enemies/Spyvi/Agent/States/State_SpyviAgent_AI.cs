...
public class State_SpyviAgent_AI : BaseState
{
    ...
    public State_SpyviAgent_AI(StateMachine_SpyviAgent sm)
    {
        agent = sm.agent;
        ...
        State_SpyviAgent_AI_Idle idle = new(sm);
        State_SpyviAgent_AI_Wander wander = new(sm);
        State_SpyviAgent_AI_Seek seek = new(sm);
        State_SpyviAgent_AI_Flee flee = new(sm);
        State_SpyviAgent_AI_Return returnn = new(sm);
